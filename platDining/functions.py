...
def createMap(merchants):
    ...
    google_tag_head = """
        ...
        })(window,document,'script','dataLayer','GTM-PHW8JV6B');</script>
    ...
    google_tag_body = """
        ...
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PHW8JV6B"
        height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        <!-- End Google Tag Manager (noscript) -->
        
        """

    m = m.get_root().render().replace('<head>', google_tag_head).replace('<body>', google_tag_body)
